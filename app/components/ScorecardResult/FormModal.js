  ...
  return (
    <Portal>
      <Modal visible={visible} onDismiss={onDimiss} contentContainerStyle={ styles.container }>
        <Text>Update {criteria.currentFieldName}</Text>
        ...
        <View style={styles.btnWrapper}>
          ...
          <Button mode="contained" contentStyle={{backgroundColor: Color.headerColor}} onPress={submit}>{translations.save}</Button>
        </View>
      </Modal>
    </Portal>
  )
