export default [
  ...
  },
  {
    ...
    notes: [
      "ដំណាក់កាលនេះគឺតម្រូវអោយ CAF អនុវត្តការពិភាក្សាលើលក្ខណៈវិនិ្នច្ឆ័យជាមួយអ្នកចូលរួមតាមធម្មតា",
      "នៅពេលចប់ការពិភាក្សាជាមួយអ្នកចូលរួមលើលក្ខណៈវិនិ្នច្ឆ័យ -> CAF ត្រូវបញ្ចូលលក្ខណៈវិនិច្ឆ័យទាំងអស់ចូលក្នុងកម្មវិធីដោយភ្ជាប់ជាមួយលេខកូដរបស់អ្នកចូលរួម",
    ],
  ...
  },
  {
    ...
    notes: [
      "ដំណាក់កាលនេះតម្រូវអោយ CAF ពិភាក្សារកសកម្មភាពអាទិភាពដូចធម្មតា ហើយ CAF គ្រាន់តែបញ្ចូលទិន្នន័យពេលដែលធ្វើការពិក្សាររួចជាការស្រេច",
    ],
