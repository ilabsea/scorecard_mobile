export default [
  ...
  },
  {
    ...
    notes: [
      ...
      "នៅពេលចប់ការពិភាក្សារជាមួយអ្នកចូលរួមលើលក្ខណៈវិនិ្នច្ឆ័យ -> CAF ត្រូវបញ្ចូលលក្ខណៈវិនិច្ឆ័យទាំងអស់ចូលក្នុងកម្មវិធីដោយភ្ជាប់ជាមួយលេខកូដរបស់អ្នកចូលរួម",
    ],
  ...
  },
  {
    ...
    notes: [
      "បន្ទាប់ពីធ្វើការបញ្ចូលលក្ខណៈវិនិច្ឆ័យចូលក្នុងកម្មវិធីអស់ហើយ CAF ធ្វើការពិភាក្សារជាមួយអ្នកចូលរួមដើម្បីកំណត់ លក្ខណៈវិនិច្ឆ័យអទិភាពដូចធម្មតា"
    ],
  ...
  },
  {
    ...
    notes: [
      "ដំណាក់កាលនេះតម្រូវអោយ CAF ពិភាក្សាររកសកម្មភាពអាទិភាពដូចធម្មតា ហើយ CAF គ្រាន់តែបញ្ចូលទិន្នន័យពេលដែលធ្វើការពិក្សាររួចជាការស្រេច",
    ],
